        ...
        <>
            <div className=" bg-[#58585e] grid place-content-center rounded-br-2xl">
                ...
                <div className="grid grid-cols-[20px_auto] gap-2  ml-8 mr-8 mt-4 mb-4 ">
                    ...
                    <h2 className=" text-[18px] text-indigo-400 ">Email:<span className="text-[#F4F7F5]"> l7739298@gmail.com</span></h2>
                </div>
                <div className="grid grid-cols-[20px_auto] gap-2  ml-8 mr-8 mt-4 mb-4 ">
                    <Image src={"/chat-bubble-call.svg"} alt="githubSVG" height={20} width={20}></Image>
                    <h2 className="  text-[18px] text-indigo-400 ">Phone:<span className="text-[#F4F7F5]"> +39 376 169 5528</span></h2>
                </div>
